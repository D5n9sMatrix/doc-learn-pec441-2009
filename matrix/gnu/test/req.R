...
## -----------------------------------------------------------------------------
odd_dates <- year_month_day(2023, 2, 28:31)
odd_dates
...
## -----------------------------------------------------------------------------
x <- zoned_time_parse_complete("2023-04-26T01:30:00-05:00[America/New_York]")
x
...
## -----------------------------------------------------------------------------
x <- as.POSIXct("2023-01-01 01:00:00.2", "America/New_York")
x
...
## -----------------------------------------------------------------------------
y <- as.POSIXct(
  c("2023-01-01 01:00:00.1", "2023-01-01 01:00:00.3"), 
  "America/New_York"
)
...
## -----------------------------------------------------------------------------
naive_time_parse(
  c("2023-01-01T01:00:00.1", "2023-01-01T01:00:00.3"), 
...
## -----------------------------------------------------------------------------
x <- as.POSIXct("2023-01-01 23:00:00", "America/New_York")
...
## -----------------------------------------------------------------------------
ymdh <- year_month_day(2023, 1, 1:2, 1)
...
## -----------------------------------------------------------------------------
x <- as.POSIXct("2023-01-01", "America/New_York")
